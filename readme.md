...
```ts
//  one line
const name: string = "Akhtar Hussain";
...
-  ### `String` : We can implicitly Define a type of a variable in `Typescript` as `string`
   ...
   ```ts
   let fullName: string = "Akhtar Hussain";
...
friends = ["Akhtar Hussain", "Rahat hossain"];
friends.push("Rahat hossain");

// we can't store other type data on string[]
friends = "Akhtar"; // Error: `Type string is not assignable to type string[]`
...
isBoolean = "Akhtar Hussain"; // Errors : type 'boolean' is not assignable to type boolean[].
isBoolean = ["Rahat hossain", "rakib hossain", 20]; // Errors : Type 'string & number' is not assignable to type boolean
```
...
myTuple = ["Rahat hossain", 20, false];
myTuple[0] = "Akhtar Hussain";
myTuple[1] = 20;
myTuple[2] = true;
myTuple[2] = true;
...
myTuple[3] = "Rahat hossain"; // Errors : Type '"Rahat hossain"' is not assignable to type 'undefined'.
```
...
user.name 'Rahat hossain' // Errors: Cannot assign to 'name' because it is a read-only
...
-  Example:
   ...
   ```ts
      ...
      type number; add(29, "Akhtar Hussain"); // Errors : Type String is not
...
-  By using `JavaScript` `spreed operator ` we can spreed or copy any object or
   ...
   const others: string[] = ["Rahat santo", "sifat hossain ", "nayeam hossain"];
...
function sendGreetingToFriends(...friends: string[]): void {
   friends.forEach((i) => {
      console.log(
         `Hey ${i}, CongRahatation in our typescript technocrat course `
      );
   });
}
...
const myInfo = {
   ...
   age: 30,
   phoneNumber: "01568713080",
   email: {
      primaryEmail: "itsakhtar@mail.ru",
      secondaryEmail: "itsakhtar@outlook.com",
   },
   bloodGroup: "B+",
};
...
-  ### Tuple in Type Alias:
   ...
   const user1: TUserData = ["Akhtar Hussain", 21, false];
   const user2: TUserData = ["Mustafizur Rahman", 20, false];
...
type TUserName = "Akhtar" | "Fahim" | "Roman";

const userName: TUserName = "Akhtar";
...
-  Example :
   ...
   const user1 : TUserName = 'Akhtar Hussain";
   ...
   // output1: isAvail1 =Akhtar Hussain
